...
import com.yhr.common.rabbit.service.RabbitService;
...
import com.yhr.yygh.mapper.OrderMapper;
...
import com.yhr.yygh.user.client.PatientFeignClient;
import com.yhr.yygh.vo.hosp.ScheduleOrderVo;
import com.yhr.yygh.vo.msm.MsmVo;
import com.yhr.yygh.vo.order.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, OrderInfo> implements OrderService {
    ...
    public OrderInfo getOrder(String orderId) {
        ...
        return packageOrderInfo(orderInfo);
    }

    @Override
    public IPage<OrderInfo> selectPage(Page<OrderInfo> page1, OrderQueryVo orderQueryVo) {
        ...
        Page<OrderInfo> orderInfoPage = baseMapper.selectPage(page1, wrapper);
